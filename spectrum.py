...
class Spectrum(object):
    ...
    #Ask which band you want to import

    naxis1 = int(hdr[naxis1_kw])
    start_pix = float(hdr[start_pix_kw])
...
def main():
    myspec = createSpectrumFromFile("spec.fits")
    myspec2 = createSpectrumFromFile("spec2.fits")
    print(len(myspec2.wl),len(myspec2.fl))
